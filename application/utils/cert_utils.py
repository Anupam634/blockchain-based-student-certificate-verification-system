...
def generate_certificate(output_path, uid, candidate_name, course_name, org_name, cgpa_total, institute_logo_path):
    ...
    recipient_text = f"This is to certify that<br/><br/>\
                    ...
                    <font color='red'> {uid} </font> <br/><br/>\
                     ...
                     with cgpa:<br/>\
                     <font color='red'>{cgpa_total} </font>"
...
def extract_certificate(pdf_path):
    with pdfplumber.open(pdf_path) as pdf:
        ...
        return (uid, candidate_name, course_name, org_name, cgpa_total)